        ...
        messages.map((message, index) => (
          ...
          >
            ...
            {message.type === 'bot' ? (
              ...
              <div class="w-[30px] flex flex-col relative items-center border border-black rounded-xl">
                <div class="relative h-[30px] w-[30px] p-1 rounded-sm text-black flex items-center font-bold text-lg justify-center">
